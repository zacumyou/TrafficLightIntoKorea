...
public partial class IndividualSignalTool:ToolBaseSystem {
 ...
 protected override void OnStopRunning(){Hover(Entity.Null);World.GetExistingSystemManaged<IndividualSignalUI>()?.Close();base.OnStopRunning();}
