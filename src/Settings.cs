...
public bool BulkBusy()=>KoreanJunctionSystem.Active==null||KoreanJunctionSystem.Active.BulkUnavailable;
[SettingsUISection("Other","Actions"),SettingsUIButton,SettingsUIConfirmation("TLK.Bulk.ApplyConfirm"),SettingsUIDisableByCondition(typeof(Settings),nameof(BulkBusy))] public bool ApplyAllJunctions {set{KoreanJunctionSystem.ApplyAllFromSettings();}}
[SettingsUISection("Other","Actions"),SettingsUIButton,SettingsUIConfirmation("TLK.Bulk.RestoreConfirm"),SettingsUIDisableByCondition(typeof(Settings),nameof(BulkBusy))] public bool RestoreAllJunctions {set{KoreanJunctionSystem.RestoreAllFromSettings();}}
[SettingsUISection("Other","Actions")] public string RestoreAllStatus=>KoreanJunctionSystem.RestoreStatus;
[SettingsUISection("Other","Actions"),SettingsUIButton] public bool Reset {set{SetDefaults();ApplyAndSave();}}
[SettingsUISection("Other","Actions")] public string Version=>typeof(Settings).Assembly.GetName().Version.ToString(3);
